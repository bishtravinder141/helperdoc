...
import { AboutInfo, extractNameFromUrl, generateKey, successType } from "../../Constant/Constant";
...
import { VerifyUser } from "../../Services/AdminServices/AdminApi";

const AgencyFullProfile = () => {
                            ...
                            {subKey === "height" ? (
                              <span>
                                ...
                                {helperDetails?.aboutYou[key][subKey] &&
                                  `${helperDetails?.aboutYou[key][subKey]} ${t("cm")}`}
                              </span>
                            ) : (
                              <span>
                                {" "}
                                {helperDetails?.aboutYou[key][subKey] &&
                                  `${helperDetails?.aboutYou[key][subKey]} ${t("kg")}`}
                              </span>
                            )}
                          </span>
                        </>
          ...
          <Card variant="outlined" className="profileCard">
            <CardContent>
              ...
              {helperDetails?.education?.licensesAndCertificates ? (
                <DocumentListing
                  haveToVerify={pathname.includes("admin/job-seeker-detail/")}
                  documents={helperDetails?.education?.licensesAndCertificates}
...
export default AgencyFullProfile;
